...
def model_training_routine(device, model, args, training_dataset, testing_dataset, training_run_results):
    ...
    for epoch in range(epochs): 
        ...
        for batch_n, batch in enumerate(training_dataloader):
            ...
            if batch_n == 0 & epoch == 0: pde_weights.set_intial_loss(pde_l1,pde_l2,pde_l3)
...
if __name__ == '__main__':
    ...
    names = ['ansatz_sub_4']#, 'ansatz_sub_4', 'ansatz_sub_2']
    subs = [4]#,4,2]
    ...
    for i in range(len(names)):
        ...
        model_training_routine(model, training_args, dataset, eval_dataset, training_run_results)
